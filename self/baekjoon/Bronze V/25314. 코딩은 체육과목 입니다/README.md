# [코딩은 체육과목 입니다](https://www.acmicpc.net/problem/25238)

| 시간 제한 | 메모리 제한 | 제출 | 정답 | 맞힌 사람 | 정답 비율 |
| --- | --- | --- | --- | --- | --- |
| 0.5 초 (추가 시간 없음) | 1024 MB (추가 메모리 없음) | 82282 | 52291 | 47402 | 64.328% |

## 문제

![image](https://github.com/wkdtjdwns/Python/assets/128266768/72334db8-d473-4d65-9e16-d957542a917a)
